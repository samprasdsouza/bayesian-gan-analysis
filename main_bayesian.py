...
from custom_dataset import CustomDataset  # Importing the CustomDataset class
...
def run(dataset, net_type):
    ...
    train_root_dir = './data/WildRF/test'
    test_root_dir = './data/WildRF/train'
    val_root_dir = './data/WildRF/val'

    # # Create dataset instances
    trainset = CustomDataset(root_dir=train_root_dir, transform=transform)
    testset = CustomDataset(root_dir=test_root_dir, transform=transform)
    valset = CustomDataset(root_dir=val_root_dir, transform=transform)
